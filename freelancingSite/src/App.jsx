      ...
      <div className="w-full min-h-screen bg-gray-100 text-black  flex flex-col items-center px-4">
        ...
        <div className="relative w-full ">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={scrollLeft}
            className="absolute left-3 top-1/2  z-10 bg-white/20 backdrop-blur-md hover:bg-white/30 p-2 rounded-full shadow-lg"
          >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={scrollRight}
            className="absolute right-3 top-1/2  z-10 bg-white/20 backdrop-blur-md hover:bg-white/30 p-2 rounded-full shadow-lg"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6 text-black dark:text-white">
